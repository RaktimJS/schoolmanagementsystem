...
def info():
        ...
        print("\tThis project is free to use for personal and educational purposes\n\twithout any fees.")
        print("")
        ...
        print("\tModifying and redistributing altered versions of this\n\tproject are strictly prohibited. If you wish to make\n\tchanges, you must keep them within your own work and\n\tnot distribute them.")
        print("")
